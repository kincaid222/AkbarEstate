...
export default function Profile() {
  ...
  const [fileUploadError, setFileUploadeError] = useState(false);
    ...
    return (
      ...
      my-7"
        ...
        <button
          ...
          className="text-white bg-blue-700 w-full p-3 rounded-lg uppercase text-center  hover:opacity-95"
        >
          Show Listings
        </button>
